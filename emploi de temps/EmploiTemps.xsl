                        ...
                        <fo:table-body>
                            <fo:table-row>
                                ...
                                <fo:table-cell width="18cm" height="4cm" margin-right="0.8cm">
                                    <fo:block font-family="Roboto" font-size="34px" color="#02306E" text-align="center"
                                              margin-top="0.9cm" margin-left="2.5cm"
                                              font-style="italic">
                        ...
                        <fo:table-body>
                            <fo:table-row>
                                ...
                                <fo:table-cell width="1.5cm">
                                    <fo:block font-family="Roboto" font-size="24px" color="#000000" text-align="center"
                                              margin-top="-0.8cm" margin-left="10cm"
                                    >
                                ...
                                <fo:table-cell width="2cm" height="4cm" margin-right="0.8cm">
                                    <fo:block margin-top="-0.9cm" margin-left="9.7cm">
                                        <fo:instream-foreign-object>
                                            <svg width="85" height="34" viewBox="0 0 80 24" fill="none"
                                                 xmlns="http://www.w3.org/2000/svg">
                                                <rect x="0.5" y="0.5" width="79" height="27.5" fill="white"
                                                      stroke="black"/>
                                            </svg>
                                        </fo:instream-foreign-object>
                                    </fo:block>
                                    <fo:block font-family="Roboto" font-size="24px" color="#000000" text-align="center"
                                              margin-top="-0.75cm" margin-left="10.1cm"
                                    >
                                ...
                                <fo:table-cell width="1.5cm">
                                    <fo:block font-family="Roboto" font-size="24px" color="#000000" text-align="center"
                                              margin-top="-0.8cm" margin-left="10.5cm"
                                    >
                                ...
                                <fo:table-cell width="2cm">
                                    <fo:block margin-top="-0.94cm" margin-left="10cm">
                                        <fo:instream-foreign-object>
                                            <svg width="85" height="37" viewBox="0 0 80 24" fill="none"
                                                 xmlns="http://www.w3.org/2000/svg">
                                                <rect x="0.5" y="0.5" width="79" height="28" fill="white"
                                                      stroke="black"/>
                                            </svg>
                                        </fo:instream-foreign-object>
                                    </fo:block>
                                    <fo:block font-family="Roboto" font-size="24px" color="#000000" text-align="center"
                                              margin-top="-0.75cm" margin-left="10.7cm"
                                    >
                                                ...
                                                <fo:table-body>
                                                    <fo:table-cell>
                                                        ...
                                                        <fo:block font-size="18px" text-align="center"
                                                                  margin-left="-0.5cm">
                                                            <xsl:value-of
                                                                    select="e:matieres/e:matiere1suite/e:nomProf"/>
                                                            <!--PROF-->
                                                        </fo:block>
                                                        <fo:block font-size="18px" text-align="center"
                                                                  margin-left="-0.3cm">
                                        ...
                                        <fo:block width="1.5cm"
                                            ...
                                            <fo:instream-foreign-object margin-left="-4cm">
                                                <svg width="175" height="130" viewBox="0 0 98 55" fill="none"
                                                     xmlns="http://www.w3.org/2000/svg">
                                                    <rect x="-0.09772" y="0.985062" width="95.4644" height="52.8319"
                                                          rx="11.5" fill="#42E427" stroke="black"/>
                                                    <line x1="1.52698" y1="11.1227" x2="95.1328" y2="11.1227"
                                                          stroke="black"/>
                                                </svg>
                                                ...
                                                <fo:table-body>
                                                    <fo:table-cell>
                                                        <fo:block font-size="16px" text-align="center"
                                                                  margin-top="0.1cm" width="3.6cm" margin-left="-0.1cm">
                                    ...
                                    <fo:block>
                                        <fo:block width="1.5cm"
                                            ...
                                            <fo:instream-foreign-object margin-left="-4cm">
                                                <svg width="175" height="130" viewBox="0 0 98 55" fill="none"
                                                     xmlns="http://www.w3.org/2000/svg">
                                                    <rect x="-0.09772" y="0.985062" width="95.4644" height="56.8319"
                                                          rx="11.5" fill="#F9FCA9" stroke="black"/>
                                                    <line x1="1.52698" y1="11.1227" x2="95.1328" y2="11.1227"
                                                          stroke="black"/>
                                                </svg>
                        ...
                        <fo:table-body>
                            <fo:table-row>
                                ...
                                <fo:table-cell width="8cm">
                                    <fo:block font-family="Roboto" font-size="24px" color="#000000" margin-top="1cm"
                                              margin-left="3cm"
                                    >
                                ...
                                <fo:table-cell width="4cm" margin-top="1cm">
                                    <fo:block margin-top="1cm" margin-left="3.7cm">
                                        <fo:instream-foreign-object>
                                            <svg width="85" height="34" viewBox="0 0 80 24" fill="none"
                                                 xmlns="http://www.w3.org/2000/svg">
                                                <rect x="0.5" y="0.5" width="79" height="27.5" fill="#C17FE9"
                                                      stroke="black"/>
                                            </svg>
                                        </fo:instream-foreign-object>
                                    </fo:block>
                                    <fo:block font-family="Roboto" font-size="24px" color="#000000" text-align="center"
                                              margin-top="-0.75cm" margin-left="1.9cm"
                                    >
                                ...
                                <fo:table-cell width="4cm">
                                    <fo:block margin-top="1cm" margin-left="4cm">
                                        <fo:instream-foreign-object>
                                            <svg width="85" height="37" viewBox="0 0 80 24" fill="none"
                                                 xmlns="http://www.w3.org/2000/svg">
                                                <rect x="0.5" y="0.5" width="79" height="28" fill="#42E427"
                                                      stroke="black"/>
                                            </svg>
                                        </fo:instream-foreign-object>
                                    </fo:block>
                                    <fo:block font-family="Roboto" font-size="24px" color="#000000" text-align="center"
                                              margin-top="-0.75cm" margin-left="2.7cm"
                                    >
                                ...
                                <fo:table-cell width="4cm">
                                    <fo:block margin-top="1cm" margin-left="4cm">
                                        <fo:instream-foreign-object>
                                            <svg width="85" height="37" viewBox="0 0 80 24" fill="none"
                                                 xmlns="http://www.w3.org/2000/svg">
                                                <rect x="0.5" y="0.5" width="79" height="28" fill="#F9FCA9"
                                                      stroke="black"/>
                                            </svg>
                                        </fo:instream-foreign-object>
                                    </fo:block>
